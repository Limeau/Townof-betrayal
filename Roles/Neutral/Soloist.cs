...
namespace TOHE.Roles.Neutral
{
    public static class Soloist
    {
        ...
        public static void SetupCustomOption()
        {
            ...
            HasImpostorVision = BooleanOptionItem.Create(Id + 12, "HasImpostorVision", true, TabGroup.NeutralRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Soloist]);
